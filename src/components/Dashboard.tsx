...
import {
  Plus, Folder as FolderIcon, FileText, Trash2, Search, Lock, Settings as SettingsIcon, MoreVertical, Languages,
} from "lucide-react";
...
export function Dashboard({ onOpenMeeting, onOpenSettings }: Props) {
  const { t, lock, settings, updateSettings, lang } = useApp();
        ...
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center gap-1">
            <Button
              variant="ghost"
              size="icon"
              onClick={() => updateSettings({ ...settings, language: lang === "en" ? "he" : "en" })}
